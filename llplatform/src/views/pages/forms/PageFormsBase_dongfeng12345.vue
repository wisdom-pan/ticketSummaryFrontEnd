      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane class="Form" label="工单详情" name="second">
          <el-card shadow="hover">
            ...
            >
              <el-col :span="11">
                <el-form-item label="工单标题" prop="ticketTitleType">
                  <el-input v-model="ruleFormOutput.ticketTitleType"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="18">
              ...
              <el-col :span="11">
                <el-form-item label="是否回访" prop="isVisitType">
                  <el-radio-group v-model="ruleFormOutput.isVisitType">
              ...
              <el-col :span="11">
                <el-form-item label="紧急程度" prop="emergencyLevelType">
                  <el-radio-group v-model="ruleFormOutput.emergencyLevelType">
                    <el-radio label="是"></el-radio>
                    <el-radio label="否"></el-radio>
                  </el-radio-group>
                </el-form-item>
              ...
              <el-col :span="18">
                <el-form-item label="车辆底盘号" prop="carNumber">
                  <el-input v-model="ruleFormOutput.carNumber"></el-input>
                </el-form-item>
              </el-col>
              
              <el-col :span="18">
              <el-form-item label="诉求内容" prop="contentType">
                <el-input
                  v-model="ruleFormOutput.contentType"
                  type="textarea"
              ...
              <el-col :span="18">
                <el-form-item label="诉求目的" prop="goal">
                  <el-input v-model="ruleFormOutput.goal"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="18">
              <el-form-item>
...
export default {
  name: "PageFormsBase_dongfeng12345",
  data() {
    const generateData2 = () => {
      const data = [];
  ...
  methods: {
    ...
    convertData(resultData){
      ...
      this.ruleFormOutput.carNumber = resultData.车辆底盘号
      this.ruleFormOutput.emergencyLevelType = resultData.紧急程度
      this.ruleFormOutput.isVisitType = resultData.是否回访
      this.ruleFormOutput.ticketTitleType = resultData.工单标题
      this.ruleFormOutput.contentType = resultData.诉求内容
      this.ruleFormOutput.goal = resultData.诉求目的 
    },
     async postData(){
       await axios.post(('/api/index/dongfeng'),this.ruleFormInput)
                    .then((result) => {
                    this.resultData = JSON.parse(result.data)
                    this.convertData(this.resultData);
                    console.log("********东风通信工单详情**********",this.ruleFormOutput)
                    })
